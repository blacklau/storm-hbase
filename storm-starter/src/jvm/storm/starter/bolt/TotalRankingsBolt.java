...
import storm.starter.HBaseInsert;
...
public final class TotalRankingsBolt extends AbstractRankerBolt {
  ...
  void updateRankingsWithTuple(Tuple tuple) {
    ...
    List<Rankable> ranks = rankingsToBeMerged.getRankings();
    for(Rankable r:ranks){
    	HBaseInsert.insert("totalranking", "info", "content", 
    			r.getObject().toString(), Long.toString(r.getCount()).getBytes());
    	//System.out.println(r.getObject().toString()+":"+r.getCount());
    }
  }
